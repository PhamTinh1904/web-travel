          ...
          <Col lg='6'>
            <div className="newsletter__content py-12">
              ...
              <div className='newsletter__input relative my-5'>
                <input className='w-full shadow py-3 px-2 outline-none' type="text" placeholder='Enter your email'/>
                <button className='btn newsletter__btn text-white absolute right-0 top-1/2 -translate-y-1/2 mr-2 px-3'>Subscribe</button>
              </div>
