            ...
            <Col lg="6">
              <div className="hero__content">
                ...
                <p className="leading-loose">
                  ...
                  eveniet, sunt ipsam quos corporis nihil aperiam explicabo nam
                  saepe quaerat alias eius et.
                </p>
              </div>
            </Col>
          ...
          <Row>
            <Col lg="6">
              <div className="experience__content">
                ...
                <p className=" w-96 text-justify">
                  ...
                  veniam quis, officia reiciendis atque quam nostrum vero
                  corrupti ullam iure distinctio, delectus suscipit cumque eaque
                  libero sint illo pariatur.
                </p>
              </div>
            ...
            <Col lg="6">
              <div className="experience__img">
                <img className=" w-11/12 object-cover" src={experienceImg} />
              </div>
            </Col>
          </Row>
        </Container>
